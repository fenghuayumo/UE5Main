...
static FAutoConsoleVariableRef CVarSurfelGISamplesPerPixel(
	TEXT("r.Fusion.SurfelGI.SamplesPerPixel"),
...
void FDeferredShadingSceneRenderer::PrepareFusionSurfelGI(const FViewInfo& View, TArray<FRHIRayTracingShader*>& OutRayGenShaders)
{
...
void FDeferredShadingSceneRenderer::FusionAllocateSurfels(FRDGBuilder& GraphBuilder,
...
bool FDeferredShadingSceneRenderer::FusionSurfelTrace(FRDGBuilder& GraphBuilder,
	FSceneTextureParameters& SceneTextures,
	FViewInfo& View,
	...
	FSurfelBufResources& SurfelRes)
{
	...
	// TODO: use raydispatchindirect will be better for perfermance
	{
		...
		PassParameters->AccumulateEmissive = FMath::Clamp(CVarFusionSurfelAccumulateEmissive.GetValueOnRenderThread(), 0, 1);
...
bool FDeferredShadingSceneRenderer::RenderFusionSurfelGI(FRDGBuilder& GraphBuilder,
	FSceneTextureParameters& SceneTextures,
	FViewInfo& View,
	const IScreenSpaceDenoiser::FAmbientOcclusionRayTracingConfig& RayTracingConfig,
	int32 UpscaleFactor,
	...
	FSurfelBufResources& SurfelRes)
{
	...
	FusionAllocateSurfels(GraphBuilder, SceneTextures, View, SurfelRes);

	FusionSurfelTrace(GraphBuilder, SceneTextures, View, RayTracingConfig, UpscaleFactor, OutDenoiserInputs, SurfelRes);
